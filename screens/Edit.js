  ...
  useQuery('edit', getAllData, {
    ...
    onSuccess: async data => {
      ...
      if (data) {
        ...
        if (data.solarCal === 'solar') {
          setSelectedCalendar(new IndexPath(0));
        } else {
          setSelectedCalendar(new IndexPath(1));
        }

        setSelectedTime(new IndexPath(data.time));
      }
    },
  });
